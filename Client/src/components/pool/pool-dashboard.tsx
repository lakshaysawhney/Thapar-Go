				...
				>
					<div className="relative flex-grow">
						...
						<Input
							...
							className="pl-10 bg-white/20 dark:bg-black/20 border-white/20 dark:border-white/10 backdrop-blur-md focus-visible:ring-primary placeholder:text-black text-foreground"
